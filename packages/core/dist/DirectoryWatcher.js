...
var watchers = [];
export function AttachDirectoryWatcher(dir, callback) {
    var watcher = chokidar.watch(dir).on("all", function (event, file) {
        callback(event, file);
    });
...
process.on("exit", function () {
    watchers.forEach(function (watcher) { return __awaiter(void 0, void 0, void 0, function () {
